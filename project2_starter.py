...
class Character:
    ...
    def attack(self, target):
        ...
        dp_points = target.take_damage(self.strength * 1.2)
        print(f"{target} took {dp_points} points of damage)")
...
class Player(Character):
    ...
    def __init__(self, name, character_class, health, strength, magic, level=0, experience=0.0):
        """
